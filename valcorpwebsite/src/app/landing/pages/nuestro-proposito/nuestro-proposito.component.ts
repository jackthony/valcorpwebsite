...
export default class NuestroPropositoComponent {
   ...
   faqs: FAQ[] = [
    ...
    { question: '¿Cuándo se entregan los proyectos?', answer: 'El proyecto Urb. Villa Los Robles será entregrado en Febrero del 2025. En cambio, el proyecto Urb. Los Huertos de San José está programado a entregarse en 2026. Cabe indicar que los poryectos se entregarán completamente saneados y con todas las zonas exclusivas prometidas de acuerdo a cada proyecto.', open: false },
